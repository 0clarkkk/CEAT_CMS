                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-yellow-500 hover:shadow-lg transition">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <a href="{{ route('faculty.consultations.index', ['status' => 'pending']) }}" class="text-xs text-yellow-600 hover:text-yellow-700 mt-2 inline-flex items-center">
                                View All →
                            </a>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500 hover:shadow-lg transition">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <a href="{{ route('faculty.consultations.index') }}" class="text-xs text-blue-600 hover:text-blue-700 mt-2 inline-flex items-center">
                                View Schedule →
                            </a>
                        </div>
