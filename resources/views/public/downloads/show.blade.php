...
<div class="bg-gradient-to-b from-maroon-50 to-white" style="padding-top: 120px; padding-bottom: 80px;">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Link -->
        <a href="{{ route('view.downloads') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-maroon-100 hover:bg-maroon-200 text-maroon-700 font-semibold text-sm transition-all duration-300 border border-maroon-200 hover:border-maroon-300 mb-8">
