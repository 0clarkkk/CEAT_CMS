            ...
            <div class="hidden lg:flex items-center gap-6 flex-1 justify-center" style="font-family: 'Inter', 'Segoe UI', sans-serif;">
                ...
                <div class="relative">
                    <button @click="academicsOpen = !academicsOpen" 
                            @click.away="academicsOpen = false"
                            ...
                            :class="isScrolled ? 'hover:bg-white/20 hover:shadow-lg hover:scale-105' : 'hover:bg-maroon-100 hover:shadow-lg hover:scale-105'" 
                            class="px-3 py-2 rounded-lg">
                        Academics
                        <svg class="w-4 h-4 transition-transform" :class="academicsOpen && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="academicsOpen" 
                        ...
                        <a href="{{ route('view.academics.programs') }}" class="block px-4 py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 transition-colors">Programs</a>
                        <a href="{{ route('view.academics.research') }}" class="block px-4 py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 transition-colors">Research Centers</a>
                        <a href="{{ route('view.academics.departments') }}" class="block px-4 py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 transition-colors">Departments</a>
                        <a href="{{ route('view.academics.curriculum') }}" class="block px-4 py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 transition-colors border-t border-gray-200">Curriculum</a>
                    </div>
                </div>
        ...
        <div x-show="mobileOpen" x-transition class="lg:hidden w-full pb-4" :style="isScrolled ? 'border-top: 1px solid rgba(255, 255, 255, 0.1); color: white;' : 'border-top: 1px solid rgba(127, 20, 22, 0.1); color: #7f1416;'" style="font-family: 'Inter', 'Segoe UI', sans-serif;">
            ...
            <div>
                <button @click="academicsOpen = !academicsOpen" 
                    ...
                    Academics
                    <svg class="w-4 h-4 ml-auto transition-transform" :class="academicsOpen && 'rotate-180'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                    </svg>
                </button>
                <div x-show="academicsOpen" 
                    ...
                    <a href="{{ route('view.academics.programs') }}" :style="isScrolled ? 'color: white;' : 'color: #7f1416;'" style="font-weight: 400; font-size: 13px; padding: 10px 32px; display: block; letter-spacing: 0.3px; transition-colors duration-300;">Programs</a>
                    <a href="{{ route('view.academics.research') }}" :style="isScrolled ? 'color: white;' : 'color: #7f1416;'" style="font-weight: 400; font-size: 13px; padding: 10px 32px; display: block; letter-spacing: 0.3px; transition-colors duration-300;">Research Centers</a>
                    <a href="{{ route('view.academics.departments') }}" :style="isScrolled ? 'color: white;' : 'color: #7f1416;'" style="font-weight: 400; font-size: 13px; padding: 10px 32px; display: block; letter-spacing: 0.3px; transition-colors duration-300;">Departments</a>
                    <a href="{{ route('view.academics.curriculum') }}" :style="isScrolled ? 'color: white;' : 'color: #7f1416;'" style="font-weight: 400; font-size: 13px; padding: 10px 32px; display: block; letter-spacing: 0.3px; transition-colors duration-300;">Curriculum</a>
                </div>
            </div>
