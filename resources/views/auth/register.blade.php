...
<head>
    ...
    <title>CEAT - Authentication</title>
...
<body>
    <div class="auth-container">
        <div class="auth-box" id="authBox">
            ...
            <!-- REGISTER FORM -->
            <div class="form-column register-form visible-form" id="registerForm">
                <div class="mb-8">
            ...
            <div class="brand-panel register-panel visible-form" id="registerBrand">
                <div class="brand-content">
                    <div class="logo-badge">
                        <div class="logo-icon">
